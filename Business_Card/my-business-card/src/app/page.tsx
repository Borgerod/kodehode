	...
	return (
		<main className="h-170 flex flex-row gap-8 px-10">
			...
			<div className="flex flex-col gap-8 max-w-150 h-full min-h-0">
				...
				>
					<h2 className="text-xl font-display mb-4 ">My Projects</h2>
					{/* wrap grid in an overflow-safe container so it fits the parent's height */}
					{/* <ButtonGrid color="grey" frosted > */}
					<ButtonGrid frosted>
						<a className="text-base" href="https://b_1.com">
							b_1
						</a>
						<a className="text-base" href="https://b_2.com">
							b_2
						</a>
						<a className="text-base" href="https://b_3.com">
							b_3
						</a>
						<a className="text-base" href="https://b_4.com">
							b_4
						</a>
						<a className="text-base" href="https://b_5.com">
							b_5
						</a>
						<a className="text-base" href="https://b_6.com">
							b_6
						</a>
						<a className="text-base" href="https://b_7.com">
							b_7
						</a>
						<a className="text-base" href="https://b_8.com">
							b_8
						</a>
					</ButtonGrid>
				</FrostedGlass>
				...
				<div className="flex flex-row gap-8 grow-2 basis-0 min-h-0">
					...
					>
						<h2 className="text-xl font-display mb-4 ">Links</h2>
						<div className="flex flex-col justify-evenly grow h-full w-full min-h-0">
							...
							<Button
								...
								mode="icon"
								color="black"
								className="p-3 flex justify-center align-middle"
							>
